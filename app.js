...
const MONGODB_URI = process.env.MONGODB_URI || (isProduction ? '' : 'mongodb://127.0.0.1:27017/khatabook');
if (!MONGODB_URI) {
    console.error('Missing MONGODB_URI environment variable in production. Set it in your hosting dashboard.');
    process.exit(1);
}
